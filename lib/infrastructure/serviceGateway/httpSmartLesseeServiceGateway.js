...
const {SMARTGRID_WECHAT_PORTAL_SERVICE_HOST = "127.0.0.1", SMARTGRID_WECHAT_PORTAL_SERVIC_PORT = "3001"} = process.env;
class Gateway {
    constructor() {
    ...
    authMember(memberID, traceContext, callback) {
        var url = `http://${SMARTGRID_WECHAT_PORTAL_SERVICE_HOST}:${SMARTGRID_WECHAT_PORTAL_SERVIC_PORT}/members/${memberID}`;
        var options = {
            method: "GET",
            path: url
        };
